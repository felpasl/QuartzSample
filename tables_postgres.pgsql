...
CREATE SCHEMA quartz AUTHORIZATION postgres;
...
create index idx_quartz.qrtz_j_req_recovery on quartz.qrtz_job_details(requests_recovery);
create index idx_quartz.qrtz_t_next_fire_time on quartz.qrtz_triggers(next_fire_time);
create index idx_quartz.qrtz_t_state on quartz.qrtz_triggers(trigger_state);
create index idx_quartz.qrtz_t_nft_st on quartz.qrtz_triggers(next_fire_time,trigger_state);
create index idx_quartz.qrtz_ft_trig_name on quartz.qrtz_fired_triggers(trigger_name);
create index idx_quartz.qrtz_ft_trig_group on quartz.qrtz_fired_triggers(trigger_group);
create index idx_quartz.qrtz_ft_trig_nm_gp on quartz.qrtz_fired_triggers(sched_name,trigger_name,trigger_group);
create index idx_quartz.qrtz_ft_trig_inst_name on quartz.qrtz_fired_triggers(instance_name);
create index idx_quartz.qrtz_ft_job_name on quartz.qrtz_fired_triggers(job_name);
create index idx_quartz.qrtz_ft_job_group on quartz.qrtz_fired_triggers(job_group);
create index idx_quartz.qrtz_ft_job_req_recovery on quartz.qrtz_fired_triggers(requests_recovery);
